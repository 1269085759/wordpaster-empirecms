...
$pathRel = "/empirecms/d/file/p/$timeDir/";
//C:\wamp64\www\empirecms\e\admin\ecmseditor\WordPaster/upload/2019/10-10
$uploadDir = dirname(__FILE__).'\..\..\..\..\\d\\file\\p\\'.$timeDir;
$curDomain = "http://".$_SERVER["HTTP_HOST"];
//相对路径 http://www.ncmem.com/upload/2012-1-10/
$relatPath = $curDomain .$pathRel;
